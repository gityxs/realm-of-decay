...
var cnItems = {
    ...
    "Holy Radiance": "神圣光辉",
    "Explosive Shot": "爆炸射击",
    "Corrupted Treant suffers from Explosive Shot.": "腐化树人遭受爆炸射击。",
    "Corrupted Treant suffers from Holy Radiance.": "腐化树人受到神圣光辉的影响。",
    ...
    "Explosive Shot triggers, dealing 462 damage to the Corrupted Treant.": "爆炸射击触发，对腐化树人造成 462 点伤害。",
    "Holy Radiance": "神圣光辉",
    "Tar Globule suffers from Holy Radiance.": "焦油球受到神圣光辉的影响。",
    " cleared!": " 已清理！",
...
var cnRegReplace = new Map([
    ...
    [/^(.+) suffered (.+) additional damage from Wound Poison.$/, '$1 受到伤口毒药的额外 $2 点伤害。'],
