...
var cnItems = {
    ...
    "Have 100 stat points allocated to Constitution.": "将 100 点统计点分配给宪法。",
    "Have 100 stat points allocated to Dexterity.": "将 100 点统计点分配给敏捷。",
    "Have 100 stat points allocated to Intelligence.": "有 100 个统计点分配给智力。",
    "Have 100 stat points allocated to Strength.": "将 100 点统计点分配给力量。",
    ...
    "Have a total of 200 stat points allocated.": "总共分配了 200 个统计点。",
    ...
    "Unremarkable Beanie": "不起眼的无檐小便帽",
    "Unremarkable Composite Bow": "不起眼的复合弓",
    ...
    "Usable Shiv": "可用的匕首",
    "Bloodthirst (Drain) - 10 sec.": "嗜血（吸取）- 10 秒。",
    "Brown Bear": "棕熊",
    ...
    "Bloodthirst (Drain) - 15 sec.": "嗜血（吸取）- 15 秒。",
    ...
    "Cauterize (Drain) - 15 sec.": "烧灼（排空）- 15 秒。",
    ...
    "Hat": "帽子",
    "Heavy Kilt": "厚苏格兰短裙",
    "Heavy Longcoat": "厚重长外套",
    "Heavy Trench Coat": "厚重风衣",
    "Holy Light (Drain) - 15 sec.": "圣光（吸取）- 15 秒。",
    ...
    "You gained a Stat Point!": "您获得了统计点！",
    ...
    "Deals 100% of blocked damage to your foe after a successful block.": "成功格挡后，对敌人造成 100% 格挡伤害。",
    "Deals 2% of damage taken to your foe.": "对敌人造成 2% 的伤害。",
    ...
    "Grants a 2% chance to gain an additional Stat Point when levelling up.": "升级时有 2% 的几率获得额外的统计点。",
    ...
    "Increases armour bonuses by 5%.": "护甲加值增加 5%。",
    "Increases attack speed by 3%.": "攻击速度提高 3%。",
    "Increases chance to block by 1%.": "格挡几率增加 1%。",
    "Increases critical strike chance by 3%": "暴击率提高 3%",
    "Increases damage dealt by weapons by 3%.": "武器造成的伤害提高 3%。",
    "Increases experience gain by up to 50% by using up the overflow pool.": "通过耗尽溢出池，将经验增益提高最多 50%。",
    "Increases seed gains from combat by 2%.": "战斗中获得的种子数量增加 2%。",
    "Increases seeds received from selling items by 5%.": "出售物品获得的种子增加 5%。",
    "Increases the chance of gaining a potion at the end of combat by 5%.": "战斗结束时获得药水的几率增加 5%。",
    "Increases the chance of striking first when starting combat by 20%.": "战斗开始时先发制人的几率提高20%。",
    "Increases the chance to apply your weapon's debuff by 2%.": "使武器施加减益效果的几率提高 2%。",
    "Increases the damage dealt by Flurry's secondary strike by 5%.": "乱舞的二次攻击造成的伤害增加 5%。",
    ...
    "Support Skills": "支持技能",
    "The next three attacks after a critical strike deal 5% more damage.": "暴击后接下来的 3 次攻击造成的伤害提高 5%。",
...
var cnRegReplace = new Map([
    ...
    [/^You restored (.+) health from Drain Life.$/, '您通过 汲取生命 恢复了 $1 生命值。'],
    [/^Drain Life \((.+) sec\)$/, '耗尽生命值（$1 秒）'],
    ...
    [/^Not enough scrap to reset stat points \- (.+) required.$/, '没有足够的废料来重置统计点 \- 需要 $1。'],
	[/^([\d\.]+)\/sec$/, '$1\/秒'],
	[/^([\d\.,]+)\/sec$/, '$1\/秒'],
	[/^([\d\.,]+) OOMs\/sec$/, '$1 OOMs\/秒'],
	[/^([\d\.]+) OOMs\/sec$/, '$1 OOMs\/秒'],
